    ...
    <body>
        ...
        <div id="main">
            ...
            while (topics.next()) {
                if (topics.getInt("publication_id") != 8) {%>
                                    <tr >
                                        ...
                                        <td width="82%" style="border-bottom:2px white solid;"><a href="R&Pcontent.jsp?id=<% out.print(topics.getString("publication_id"));%>" ><%=topics.getString("publication_type")%></a></td>
                                    </tr>
                                    <%}
            }%>
                                </table>
                ...
                boolean title = request.getParameter("title").equals("a")? true : false;
                boolean content = request.getParameter("title").equals("b")? true : false;
                String textarea = request.getParameter("textsearch");
            ...
            if (pt == null) {
                ...
                if(title){
                sr = src.DB.getResultset("select* from publications where publication_name like '%" + textarea+ "%' ORDER by publication_id desc limit " + currentRs + ",13 ");
                }else if(content){
                sr = src.DB.getResultset("select* from publications where Description like '%" + textarea + "%' ORDER by publication_id desc limit " + currentRs + ",13 ");
                }
               ...
               <h1><%int x=0; out.print("Search Results");%></h1>
                    <div class="text">
